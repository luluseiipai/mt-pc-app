    ...
    <ul class="nav">
      ...
      <li class="list bd">
        ...
        <dl>
          ...
          <dd><nuxt-link to="/kaipiao">上家申请开票</nuxt-link></dd>
        </dl>
      </li>
      <li class="list site">
        ...
        <div class="subContainer">
          <dl class="hotel">
            <dt>酒店旅游</dt>
            <dd v-for="index in 15" :key="index">国际机票</dd>
          </dl>
          <dl class="food">
            <dt>吃美食</dt>
            <dd v-for="index in 6" :key="index">烤鱼</dd>
          </dl>
          <dl class="movie">
            <dt>酒店旅游</dt>
            <dd v-for="index in 5" :key="index">国际机票</dd>
          </dl>
          <dl class="app">
            <dt>手机应用</dt>
            <dd>
